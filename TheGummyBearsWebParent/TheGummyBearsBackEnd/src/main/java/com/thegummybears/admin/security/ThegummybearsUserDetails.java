  ...
  import com.thegummybears.common.entity.Role; import
  com.thegummybears.common.entity.User;
  
  public class ThegummybearsUserDetails implements UserDetails {
  
  
  private User user;
  
  
  public ThegummybearsUserDetails(User user) { this.user = user; }
